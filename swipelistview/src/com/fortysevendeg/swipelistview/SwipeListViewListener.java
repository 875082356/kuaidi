...
public interface SwipeListViewListener {
    ...
    void onedit(int position,String phone,String name,String Province,String Area,String country,String Town,String Village,String postnumber);
    
    void onselect(int position,String phone,String name,String address,String Postcode);
