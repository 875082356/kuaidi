...
public class SwipeListView extends ListView {
    ...
    public void edit(int position,String phone,String name,String Province,String Area,String country,String Town,String Village,String postnumber)
    {
        onedit(position,phone,name, Province, Area,country, Town, Village,postnumber);
    }
    public void select(int position,String phone,String name,String address,String postnumber)
    {
        onselect(position,phone,name,address,postnumber);
    }
    ...
    protected void onedit(int position,String phone,String name,String Province,String Area,String country,String Town,String Village,String postnumber) {
        if (swipeListViewListener != null) {
            swipeListViewListener.onedit( position,phone, name, Province, Area,country, Town, Village, postnumber);
        }
    }
    protected void onselect(int position,String phone,String name,String address,String Postcode) {
        if (swipeListViewListener != null) {
            swipeListViewListener.onselect( position,phone, name, address,Postcode);
        }
    }
